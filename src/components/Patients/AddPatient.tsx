...
const formSchema = z.object({
  ...
  cnic: z
    ...
    .regex(/^\d{5}-\d{7}-\d{1}$/, { message: "CNIC format must be 12345-1234567-1" }),  // Added - National ID
...
const AddPatient = () => {
  ...
  const handleAddAppointment = () => {
    ...
    navigate({
      to: `/appointments?openAdd=true&flow=patient-to-appointment&patientId=${createdPatientId}`,
    })
  }
              ...
              <div className="grid gap-4 py-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        CNIC (National ID) <span className="text-destructive">*</span>
                      </FormLabel>
                      <FormControl>
                        <Input
      ...
      <Dialog open={isFlowModalOpen} onOpenChange={setIsFlowModalOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Continue the guided flow by creating an appointment for this patient.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <DialogClose asChild>
            ...
            <Button onClick={handleAddAppointment} disabled={!createdPatientId}>
              Add Appointment
            </Button>
          </DialogFooter>
        </DialogContent>
